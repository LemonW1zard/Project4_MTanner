...
class myApp(ShowBase):
    ...
    def Scene(self):
        ...
        self.Player = Player.Player(self.loader, "./Assets/Player/hornetMini.x", self.render, 'Player', "./Assets/Player/hornetMini.jpg", (0, 0, 0), 50, self.task_mgr, self.render, self.accept, self.cTrav)
